 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font /tmp/Montserrat-Bold.ttf --size 72 --bpp 4 --format lvgl --no-compress --no-prefilter --no-kerning --lv-font-name lv_font_montserrat_bold_72 --range 0x30-0x39,0xB0,0x2014 -o main/fonts/lv_font_montserrat_bold_72.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1170, .adv_w = 452, .box_w = 23, .box_h = 50, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1745, .adv_w = 680, .box_w = 41, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2791, .adv_w = 682, .box_w = 42, .box_h = 52, .ofs_x = -1, .ofs_y = -1},
    {.bitmap_index = 3883, .adv_w = 794, .box_w = 47, .box_h = 50, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5058, .adv_w = 685, .box_w = 41, .box_h = 52, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6124, .adv_w = 734, .box_w = 43, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 7242, .adv_w = 714, .box_w = 42, .box_h = 50, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 8292, .adv_w = 760, .box_w = 43, .box_h = 52, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 9410, .adv_w = 734, .box_w = 43, .box_h = 52, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10528, .adv_w = 482, .box_w = 26, .box_h = 25, .ofs_x = 2, .ofs_y = 26},
    {.bitmap_index = 10853, .adv_w = 1152, .box_w = 72, .box_h = 7, .ofs_x = 0, .ofs_y = 17}
};
