 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --font /tmp/Montserrat-Bold.ttf --size 64 --bpp 4 --format lvgl --no-compress --no-prefilter --no-kerning --lv-font-name lv_font_montserrat_bold_64 --range 0x30-0x39,0xB0,0x2014 -o main/fonts/lv_font_montserrat_bold_64.c
 ******************************************************************************/

#include "lvgl.h"

#ifndef LV_FONT_MONTSERRAT_BOLD_64
#define LV_FONT_MONTSERRAT_BOLD_64 1
#endif

#if LV_FONT_MONTSERRAT_BOLD_64
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0x6, 0xff, 0xff, 0xff, 0xa3, 0x0, 0x5, 0xcf,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 8377, .adv_w = 428, .box_w = 23, .box_h = 22, .ofs_x = 2, .ofs_y = 23},
    {.bitmap_index = 8630, .adv_w = 1024, .box_w = 64, .box_h = 7, .ofs_x = 0, .ofs_y = 15}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_bold_64 = {
#else
lv_font_t lv_font_montserrat_bold_64 = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_BOLD_64*/
